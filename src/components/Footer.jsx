...
const Footer = () => {
  return (
    <footer className="py-6 px-6 bg-gray-200 dark:bg-gray-800 text-sm dark:text-white">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex space-x-5">
          <a href="https://www.linkedin.com/in/binit-patra-762040276" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500">
            <Linkedin size={30} />
          </a>
          <a href="https://www.facebook.com/your-profile" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600">
            <Facebook size={30} />
          </a>
          <a href="https://www.instagram.com/your-profile" target="_blank" rel="noopener noreferrer" className="hover:text-pink-500">
            <Instagram size={30} />
          </a>
          <a href="https://github.com/Binit870" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 dark:hover:text-white">
            <Github size={30} />
          </a>
          <a href="https://technologiawithai.blogspot.com/" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500">
            {/* Blogger Icon SVG */}
            <svg width="30" height="30" viewBox="0 0 512 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
